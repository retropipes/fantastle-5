...
public final class PicturePicker {
	...
	this.pickerContainer
		.setPreferredSize(new Dimension(newPreferredWidth, this.pickerContainer.getPreferredSize().height));
	this.pickerContainer.setMinimumSize(this.pickerContainer.getPreferredSize());
    }
