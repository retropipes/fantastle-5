...
public class DataReader implements DataConstants {
    ...
    public DataReader(final String filename, final boolean mode) throws IOException {
	this.dataMode = mode;
    ...
    public DataReader(final File filename, final boolean mode) throws IOException {
	this.dataMode = mode;
	if (mode == DataConstants.DATA_MODE_TEXT) {
	    this.br = new BufferedReader(new FileReader(filename));
	} else {
