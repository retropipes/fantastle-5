...
public class SaveTask extends Thread {
	...
	try {
	    final DataWriter mazeFile = new DataWriter(this.filename, DataConstants.DATA_MODE_BINARY);
    ...
    private static void writeFormatVersion(final DataWriter mazeFile) throws IOException {
