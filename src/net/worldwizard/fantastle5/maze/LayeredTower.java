...
class LayeredTower {
    ...
    public static LayeredTower readLayeredTower(final DataReader reader, final int formatVersion) throws IOException {
    ...
    public void writeSavedTowerState(final DataWriter writer) throws IOException {
	this.savedTowerState.writeSavedTowerState(writer);
    }

    public void readSavedTowerState(final DataReader reader, final int formatVersion) throws IOException {
