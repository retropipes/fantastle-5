...
public class LoadTask5 extends Thread {
	...
	try {
	    final DataReader mazeFile = new DataReader(this.filename, DataConstants.DATA_MODE_BINARY);
	    try {
    ...
    private static byte[] readFormatVersion(final DataReader mazeFile) throws IOException {
