...
public class Maze5 implements Maze {
    ...
    @Override
    public Maze readMaze(final DataReader reader, final int formatVersion) throws IOException {
    ...
    @Override
    public void readSavedMazeState(final DataReader reader, final int formatVersion) throws IOException {
