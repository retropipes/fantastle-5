...
public class PCManager {
    ...
    public static void loadGameHook(final DataReader mazeFile) throws IOException {
    ...
    public static void saveGameHook(final DataWriter mazeFile) throws IOException {
